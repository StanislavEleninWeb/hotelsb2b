# Staging environment — wires the reusable modules together.
# Single-AZ RDS, single Redis node, single NAT (cost-optimized). Prod overrides
# these to Multi-AZ / HA via the same modules.
